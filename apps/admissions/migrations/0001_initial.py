    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('children', models.ManyToManyField(related_name='parents', to='admissions.student')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='student',
            name='application',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='admissions.studentapplication'),
        ),
        migrations.CreateModel(
