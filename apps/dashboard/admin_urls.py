...
urlpatterns = [
    ...
    path('timetable/class/<int:class_id>/resources/',
         ...
         # Reports & Downloads
    path('reports/academic/', reports_views.download_academic_report, name='download-academic-report'),
    path('reports/attendance/', reports_views.download_attendance_report, name='download-attendance-report'),
    path('reports/financial/', reports_views.download_financial_report, name='download-financial-report'),
    path('reports/applications/', reports_views.download_applications_report, name='download-applications-report'),
    path('reports/students/', reports_views.download_students_list, name='download-students-list'),
